...
namespace Foot_Tournoi_Brie
{
	partial class ajoutMatch
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Ajout de match au tournoi";
			// 
			// label2
			// 
			...
			this.label2.Text = "- Selection des équipes :";
			// 
			// label3
			// 
			...
			this.label5.Text = "- Selection du Terrain :";
			// 
			// label6
			// 
			...
			this.comboBox3.Location = new System.Drawing.Point(127, 177);
			...
			this.label7.Text = "- Date et heure du match :";
			// 
			// label8
			// 
			...
			// dateTimePicker1
			// 
			this.dateTimePicker1.Location = new System.Drawing.Point(127, 270);
			...
			// textBox1
			// 
			this.textBox1.Location = new System.Drawing.Point(127, 307);
			...
			this.button1.Location = new System.Drawing.Point(495, 186);
			this.button1.Name = "button1";
			this.button1.Size = new System.Drawing.Size(189, 54);
			this.button1.TabIndex = 18;
			this.button1.Text = "Enregistrer le match";
			...
			this.button2.Location = new System.Drawing.Point(599, 383);
			this.button2.Name = "button2";
			this.button2.Size = new System.Drawing.Size(195, 43);
			this.button2.TabIndex = 20;
			this.button2.Text = "Quitter l\'ajout de match";
			...
			this.Name = "ajoutMatch";
			this.Text = "ajoutMatch";
			this.Load += new System.EventHandler(this.AjoutMatchLoad);
